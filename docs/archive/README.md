...
Material in this folder is preserved for historical context only. Nothing here should be treated as the current source of truth, but it can be useful when you want to reference past research or show how decisions evolved.
