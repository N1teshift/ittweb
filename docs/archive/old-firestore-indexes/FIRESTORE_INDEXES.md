...
**Purpose**: Complete reference of all Firestore composite indexes required for ITT Web.
...
> **Need step-by-step setup?** See [Firestore Indexes Setup Guide](./FIRESTORE_INDEXES_SETUP_GUIDE.md) for detailed creation instructions.  
> **Check index status?** See [Firestore Indexes Inventory](./FIRESTORE_INDEXES_INVENTORY.md) for current status and priority actions.
...
- [FIRESTORE_INDEXES_INVENTORY.md](./FIRESTORE_INDEXES_INVENTORY.md) - Current index status and priority actions
