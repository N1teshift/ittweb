...
**Created**: 2025-01-15  
**Purpose**: Detailed step-by-step instructions for creating specific Firestore composite indexes

> **Reference**: See [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md) for complete index reference.  
> **Understanding**: See [FIRESTORE_INDEXES_EXPLAINED.md](./FIRESTORE_INDEXES_EXPLAINED.md) for how indexes work.  
> **Status**: See [FIRESTORE_INDEXES_INVENTORY.md](./FIRESTORE_INDEXES_INVENTORY.md) for current index status.
...
For complete reference of all indexes, see [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md).

### Quick Summary

| Index | Collection | Purpose | Priority |
|-------|-----------|---------|----------|
| 1-8 | `games` | Scheduled and completed games queries | See [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md) |
| 9 | `posts` | Published posts list | See [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md) |
| 10 | `playerCategoryStats` | **Standings optimization** | **Create this one** (instructions above) |
| 11 | `playerCategoryStats` | Alternative standings sorting | Optional - see [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md) |
| 12-13 | `entries` | Entries queries | See [FIRESTORE_INDEXES.md](./FIRESTORE_INDEXES.md) |
