...
5.5. **Ability ID Mapping**: Generate mapping from raw ability IDs to ability slugs
5.6. **Extract Ability Codes**: Parse ability codes from item descriptions to find missing mappings
...
- **Workspace**: Store working documents in `docs/workflow/progress/data-pipeline-agent/`
...
- `docs/systems/data-pipeline/` - Complete pipeline documentation
  - `architecture.md` - Architecture and data flow
  - `schemas.md` - Data structure documentation
  - `troubleshooting.md` - Common issues and debugging
  - `guides/` - Specialized guides (icon mapping, extraction, etc.)
...
Your workspace is located at `docs/workflow/progress/data-pipeline-agent/`:
- `plans/` - Pipeline improvement plans
- `analysis/` - Data pipeline analysis
- `migrations/` - Data migration plans

See the workspace README for details: `docs/workflow/progress/data-pipeline-agent/README.md`
