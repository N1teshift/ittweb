...
war3map.w3a
    ↓
extract/extract-from-w3x.mjs (enhanced)
    ↓
tmp/work-data/raw/abilities.json (with new fields)

Wurst Source Files
    ↓
extract/extract-ability-details-from-wurst.mjs (new)
    ↓
tmp/work-data/metadata/ability-details-wurst.json

TrollUnitTextConstant.wurst
    ↓
extract/extract-ability-relationships.mjs (new)
    ↓
tmp/work-data/metadata/ability-relationships.json

All Sources
    ↓
convert/convert-extracted-to-typescript.mjs (updated - merges all)
    ↓
...
### Modified:
- ✅ `scripts/data/extract/extract-from-w3x.mjs` - Enhanced extraction
- ✅ `scripts/data/converters/ability-converter.mjs` - New fields
- ✅ `scripts/data/convert/convert-extracted-to-typescript.mjs` - Data merging
- ✅ `src/features/modules/guides/data/abilities/types.ts` - Type definitions

### Created:
- ✅ `scripts/data/extract/extract-ability-details-from-wurst.mjs` - Wurst parser
- ✅ `scripts/data/extract/extract-ability-relationships.mjs` - Relationships extractor
- ✅ `scripts/data/docs/ABILITY_DATA_EXPLORATION.md` - Investigation doc
- ✅ `scripts/data/docs/ABILITY_IMPROVEMENTS_SUMMARY.md` - Quick reference
- ✅ `scripts/data/docs/IMPLEMENTATION_SUMMARY.md` - This file
