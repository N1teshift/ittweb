...
Create a new script: `scripts/data/extract/extract-ability-details-from-wurst.mjs`
...
Create `scripts/data/convert/merge-ability-data.mjs` to:
...
1. **New**: `scripts/data/extract/extract-ability-details-from-wurst.mjs`
   - Parse Wurst ability files
   - Extract detailed properties

2. **Modify**: `scripts/data/extract/extract-from-w3x.mjs`
   - Extract additional fields from war3map.w3a
   - Extract all ability levels

3. **New**: `scripts/data/convert/merge-ability-data.mjs`
...
6. **New**: `scripts/data/extract/extract-ability-relationships.mjs`
