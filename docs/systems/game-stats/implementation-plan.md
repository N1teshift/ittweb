...
| --- | --- | --- |
| Technical Architecture | Stack, module layout, shared services, integration points | [	echnical-architecture.md](./technical-architecture.md) |
| Data Model | Firestore collections, indexes, and security posture | [data-model.md](./data-model.md) |
| Feature Specification | User-facing capabilities, APIs, and UI components | [eature-spec.md](./feature-spec.md) |
...
- Dependencies (echarts, date-fns, eact-datepicker, zod) are already vetted; no additional runtime services are required beyond Firestore + Firebase Storage.
