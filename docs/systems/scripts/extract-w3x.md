...
4. Place them in: `external/island_troll_tribes/extracted_from_w3x/raw/`
...
```bash
# Extract all files
mpq-extract Island.Troll.Tribes.v3.28.w3x external/island_troll_tribes/extracted_from_w3x/raw/

# Or extract specific files
mpq-extract Island.Troll.Tribes.v3.28.w3x war3map.w3t external/island_troll_tribes/extracted_from_w3x/raw/
mpq-extract Island.Troll.Tribes.v3.28.w3x war3map.w3a external/island_troll_tribes/extracted_from_w3x/raw/
mpq-extract Island.Troll.Tribes.v3.28.w3x war3map.w3u external/island_troll_tribes/extracted_from_w3x/raw/
mpq-extract Island.Troll.Tribes.v3.28.w3x war3map.w3b external/island_troll_tribes/extracted_from_w3x/raw/
```
...
3. Save the data to JSON files in `external/island_troll_tribes/extracted_from_w3x/`
