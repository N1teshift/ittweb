...
import { DeleteErrorDisplay } from './DeleteErrorDisplay';
...
import {
  ...
  useGameEditDelete,
  useEntryOperations,
} from '@/features/modules/archives/hooks';
import { useGames } from '@/features/modules/games/hooks/useGames';
import { extractEntryId } from '@/features/modules/archives/utils/entryUtils';
