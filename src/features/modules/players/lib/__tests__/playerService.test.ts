...
jest.mock('@/features/modules/standings/lib/playerCategoryStatsService', () => ({
...
const { getGames, getGameById } = jest.requireMock('@/features/modules/games/lib/gameService');
const { upsertPlayerCategoryStats } = jest.requireMock('@/features/modules/standings/lib/playerCategoryStatsService');
