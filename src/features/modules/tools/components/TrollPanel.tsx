...
import InventoryGrid from '@/features/modules/tools/components/InventoryGrid';
import type { DragPayload, TrollSide, TrollLoadout } from '@/features/modules/tools/types';
import { BASE_TROLL_CLASSES, getClassBySlug, TrollClassData } from '@/features/modules/guides/data/units/classes';
import { ATTR_START_MULTIPLIER, MOVESPEED_PER_LEVEL, getMoveSpeedOffset, HP_PER_STRENGTH, MANA_PER_INTELLIGENCE, ARMOR_PER_AGILITY, getArmorDamageReductionPercent } from '@/features/modules/guides/config/balance';
import type { ItemData } from '@/types/items';
import StatsPanel, { TrollComputedStats } from '@/features/modules/tools/components/StatsPanel';
