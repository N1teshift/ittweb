...
import { getSuggestions, getGameNamesForCategory } from '@/features/ittweb/tools/icon-mapper.utils';
import type { IconFile, IconMapping, IconMappingEntry } from '@/features/ittweb/tools/icon-mapper.types';
