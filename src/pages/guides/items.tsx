  ...
  return (
    <Layout pageTranslationNamespaces={pageNamespaces}>
      <div className="min-h-[calc(100vh-8rem)] px-6 py-10 max-w-5xl mx-auto">
        ...
        <h1 className="font-medieval-brand text-4xl md:text-5xl mb-6">Items</h1>
        <p className="text-gray-300 mb-6">A comprehensive list of game items. This page is scaffolded and ready to populate from game data.</p>

        <div className="bg-black/30 backdrop-blur-sm border border-amber-500/30 rounded-lg p-6">
          <p className="text-gray-400">Coming soon: searchable, categorized item list with stats and recipes.</p>
        </div>
      </div>
    </Layout>
  );
