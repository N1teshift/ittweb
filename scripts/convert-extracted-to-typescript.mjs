...
const ABILITIES_META_FILE = path.join(ROOT_DIR, 'external', 'island_troll_tribes', 'abilities.json');
const BUILDINGS_FILE = path.join(ROOT_DIR, 'external', 'island_troll_tribes', 'buildings.json');
const UNITS_FILE = path.join(ROOT_DIR, 'external', 'island_troll_tribes', 'units.json');
