 ...
 *   external/island_troll_tribes/extracted_from_w3x/raw/
 *     - war3map.w3t (items)
 *     - war3map.w3a (abilities)
 *     - war3map.w3u (units)
 *     - war3map.w3b (buildings/destructables)
 * 
 * Usage: node scripts/extract-from-w3x.mjs
 */
...
const OUTPUT_DIR = path.join(ROOT_DIR, 'external', 'island_troll_tribes', 'extracted_from_w3x');
