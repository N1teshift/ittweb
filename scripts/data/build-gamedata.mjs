 ...
 * 
 * Outputs to:
 *   src/features/modules/guides/data/gamedata/
...
const EXTERNAL_DIR = path.join(ROOT_DIR, 'data', 'island_troll_tribes');
const OUTPUT_DIR = path.join(ROOT_DIR, 'src', 'features', 'modules', 'guides', 'data', 'gamedata');
