...
import { ITEMS_TS_DIR, ABILITIES_TS_DIR, UNITS_TS_DIR } from './paths.mjs';
...
/**
 * Get all icon files in the icons directory (case-insensitive lookup)
 * Also builds a search index for fuzzy matching
 */
...
function main() {
  ...
  const { iconMap, searchIndex } = getAllIconFiles();
