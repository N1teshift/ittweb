/**
 * Unified Icon Mapping Management Script (Refactored)
 * 
 * This is a REFACTORED version demonstrating the benefits of using shared utilities.
 * Compare with manage-icon-mapping.mjs to see the difference.
 * 
 * Usage:
 *   node scripts/icons/manage-icon-mapping-refactored.mjs [--map] [--find-missing] [--fuzzy] [--generate-list] [--update-map]
 */
...
function main() {
  console.log('🗺️  Icon Mapping Management (Refactored)\n');
  ...
  if (doMap) {
    ...
    for (const item of items) {
      if (iconMap.items[item.name]) continue;
    ...
    for (const ability of abilities) {
      if (iconMap.abilities[ability.name]) continue;
